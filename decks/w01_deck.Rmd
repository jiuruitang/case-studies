...
![Mean birthweight for gestational age (+/- SD) from Talge et al., 2014 Pediatrics](figures/gabwt.jpg){width=60%}
...
![Test MSE for 1st-10th order polynomials in $x$ from James et al (2013)](figures/val1.png){width=60%}
...
![Test MSE for 1st-10th order polynomials in $x$ over 10 splits from James et al (2013)](figures/val2.png){width=60%}
